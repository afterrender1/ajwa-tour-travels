...
const AboutUs = () => {
  return (
    <>
      ...
      >
        ...
        <p className="mb-10 text-3xl sm:text-5xl lg:text-6xl tracking-tight leading-tight text-gray-800">
          ...
          <span className="text-gray-400">
            Gods with its breathtaking beaches, terraced rice fields and rich
            culture.
          </span>
        </p>
      </div>
      ...
      {/* CONTENT */}
      <div
        className={`max-w-400 mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-20 select-none bg-white ${montserrat.className}`}
      >
        <div className="lg:grid lg:grid-cols-2 lg:gap-14 items-center">
          {/* IMAGE */}
          <div
            className="order-2 lg:order-1 mb-10 lg:mb-0 shadow-xl overflow-hidden"
            style={{
              "--r": "30px",
              WebkitMask: `
      radial-gradient(var(--r) at top left, transparent 98%, black),
      radial-gradient(var(--r) at top right, transparent 98%, black),
      radial-gradient(var(--r) at bottom right, transparent 98%, black),
      radial-gradient(var(--r) at bottom left, transparent 98%, black)
    `,
    ...
    `,
          ...
          <div className="order-1 lg:order-2 max-w-xl">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Ajwa Tours & Travels is your trusted partner for unforgettable
              travel experiences. With a passion for exploration and a
              commitment to excellence, we craft personalized journeys tailored
              to your interests.
            </p>
            ...
            <p className="mt-6 text-gray-800 font-medium">
              Ajwa Tours & Travels — where every journey becomes a lifelong
              memory.
            </p>
          </div>
        </div>
