...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`relative flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 z-50 ${montserrat.className}`}>
                {/* Left: Menu Icon */}
                <button
...
">
            ...
            {/* Drawer Sidebar */}
            <div
                className={`${montserrat.className} fixed top-0 left-0 h-full w-80 bg-white shadow-2xl z-50 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                {/* Drawer Header */}
          ...
          ${link.highlight
                                        // Highlighted Link Classes (No change to hover:bg-blue-100)
                                        ? 'text-[#1f65e9] hover:bg-blue-100 border-r-4 border-blue-600'
                                        // Standard Link Classes: Hover color added here
                            ...
                            >
                                <Icon
                                    size={24}
                                    strokeWidth={2}
                                    // Icon Class: Inherit color from parent link (text-current)
                ...
                {/* Call to Action in Drawer */}
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-linear-to-t from-gray-50 to-transparent border-t border-gray-200">
                    {/* Button */}
